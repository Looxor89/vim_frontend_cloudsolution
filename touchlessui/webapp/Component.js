sap.ui.define([
    ...
    return UIComponent.extend("touchlessui.Component", {
        ...
        init: function () {
            ...
            var oAppdata = new JSONModel(jQuery.sap.getModulePath("touchlessui", "/json/appdata.json"));
            oAppdata.setSizeLimit(1000);
            this.setModel(oAppdata, "appmodel");

            var oPersistdata = new JSONModel(jQuery.sap.getModulePath("touchlessui", "/json/persist.json"));
        ...
        getProps: function () {
            ...
            $.ajax({
                ...
                success: function (props) {
                    console.log(props);
                    // set props model
                    var oPropsModel = new JSONModel(props);
